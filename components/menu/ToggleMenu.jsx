        ...
        <>
            ...
            >
                <div className="w-8 h-8 flex flex-col justify-center items-center gap-1.5 relative">
                    <span
                        className={`block w-8 h-1 rounded transition-transform duration-300 ${isOpen ? "bg-white rotate-45 translate-y-3" : "bg-current translate-y-0"
                            }`}
                    ></span>
                    <span
                    ...
                    ></span>
                    <span
                        className={`block w-8 h-1 rounded transition-transform duration-300 ${isOpen ? "bg-white -rotate-45 -translate-y-2" : "bg-current translate-y-0"
                            }`}
                    ></span>
                </div>
            </button>
            ...
            <div
                ref={overlayRef}
                className={`fixed inset-0 z-20 bg-primary gap-y-20 text-secondary flex flex-col items-center justify-center transition-opacity duration-500 ${isOpen ? "opacity-100 visible fixed" : "opacity-0 invisible fixed"
                    }`}
            >
